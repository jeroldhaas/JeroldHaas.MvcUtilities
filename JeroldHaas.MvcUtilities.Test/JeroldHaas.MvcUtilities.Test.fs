module JeroldHaas.MvcUtilities.Test
...
open JeroldHaas.MvcUtilities

type FooController() =
    static member Name = "Foo"

[<Test>]
let ``controllernameof returns proper name``() =
    Controller.nameofcontroller typeof<FooController> |> should equal FooController.Name